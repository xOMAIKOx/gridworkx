...
```sh
timeout 30s godot --headless --editor --path apps/game --quit-after 2 --rendering-method gl_compatibility --rendering-driver opengl3 --disable-render-loop --audio-driver Dummy

...
required = [
    ...
    "length(name_display) BETWEEN 3 AND 80",
    "players_ownership_delete_guard",
    "company_groups_ownership_delete_guard",
    "closed ownership projection is immutable",
    "company_ownership_entity_lock",
    "NEW.name_display",
    "NEW.effective_from",
    "NEW.membership_id",
    "company_group_membership_delete_guard",
    "company_ownership_delete_guard",
    "company_name_claims_append_only",
    "company_group_name_identity_guard",
    "company_name_identity_guard",
    "company_name_claims",

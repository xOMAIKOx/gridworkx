...
cargo test -p gridworks-sim --test wp011_fixture
...
cp tests/deterministic/fixtures/wp011/fixture.json apps/game/bin/linux/debug/wp011-fixture.json
cp target/wp011-pure-result.json apps/game/bin/linux/debug/wp011-pure-result.json
...
test -s apps/game/bin/linux/debug/wp011-fixture.json
test -s apps/game/bin/linux/debug/wp011-pure-result.json
